...
| [NamespaceMover](./NamespaceMover) | Автоматически обновляет пространство имён при перемещении файла `.cs` в другую папку |
| [UnusedMethodsAnalyzer](./UnusedMethodsAnalyzer) | Находит неиспользуемые символы C# (методы, свойства, классы, интерфейсы, перечисления) по всему решению |
